...
const STATIC_STARTUPS = [
  ...
  "DataThings SA",
  "KLONA",
  "Action Positive (marque commercialisée Linka)",
  "Relicta Srl",
  "Corecyclage",
  "RSE Challenge",
  "GIOZA",
  ...
  "Woola",
  "Vox Illud",
  "Au revoir carbone (RSE Challenge)",
  "Z#bre",
  "Fairspace",
  "NeuralTeks",
  "My Smart Journey",
  ...
  "Filament’OR",
  "Voltyo",
  "Engagement & Performance (Powerteam)",
  "Free-visit",
  "Napta ",
  "4Gift",
  "Physioquanta",
  "Les Nouveaux Géants ",
  "TKM - Technology Knowledge Metrix",
  "Bloom media",
  "Corpoderm",
  "Flowlity",
  "OliKrom",
  ...
  "Mercaux",
  "Bioxegy",
  "Yinfy ⇒ Hair analyser & autres recherches",
  "VIDETICS",
  "E-VIRTUALITY",
  "Eclos Production",
  "Love your waste ",
  ...
  "SolarGaps",
  "Skoleom",
  "InnovFast (Move2.digital)",
  "Jobradio",
  "Pi électronique ",
  "Ecofrugal Project SAS",
  "Tamplo",
  "Algentech",
  "PENBOX ",
  "Brandaudio",
  ...
  "UBBY ENERGY",
  "Releaf Paper",
  "Cosfibel ⇒ Projet diffuseur de parfum",
  "UMI",
  "COEXEL",
  "Wonderflow",
  "Eyesee",
